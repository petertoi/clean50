<?php
/**
 * Filename class-house-ad-widget.php
 *
 * @package clean50
...
class House_Ad_Widget extends \WP_Widget_Media {
...
//        }
    ...
    public function enqueue_admin_scripts() {
        ...
        $handle = 'toibox-house-ad-widget';
        wp_enqueue_script( $handle, get_template_directory_uri() . '/../app/widgets/house-ad/toibox-house-ad-widget.js', [ 'media-widgets' ] );
    ...
    public function render_control_template_scripts() {
        ...
        ?>
        <script type="text/html" id="tmpl-toibox-house-ad-fields">
        ...
        <script type="text/html" id="tmpl-toibox-house-ad-preview">
