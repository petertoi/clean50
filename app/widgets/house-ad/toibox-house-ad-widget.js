...
( function( component, $ ) {
	...
	var ToiBoxHouseAdWidgetModel, ToiBoxHouseAdWidgetControl;
	 ...
	 */
	ToiBoxHouseAdWidgetModel = component.MediaWidgetModel.extend( {} );
	 ...
	 */
	ToiBoxHouseAdWidgetControl = component.MediaWidgetControl.extend(/** @lends wp.mediaWidgets.controlConstructors.media_image.prototype */{
		...
		renderPreview: function renderPreview() {
			...
			previewTemplate = wp.template( 'toibox-house-ad-preview' );
			...
			if ( ! linkInput.is( document.activeElement ) ) {
				...
				fieldsTemplate = wp.template( 'toibox-house-ad-fields' );
	...
	// Exports.
	component.controlConstructors.toibox_house_ad = ToiBoxHouseAdWidgetControl;
	component.modelConstructors.toibox_house_ad = ToiBoxHouseAdWidgetModel;
